...
Number() --> 숫자로 자료형을 반환한다.<br>
String() --> 문자열로 자료형 반환한다.<br>
...
ex) console.log(nan == nan); --> false<br>
    console.log(nan != nan); --> true<br>
